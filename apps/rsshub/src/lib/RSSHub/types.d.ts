// @see https://github.com/DIYgod/RSSHub/blob/master/lib/types.ts

type TODO_TYPEME = any;

type Context = TODO_TYPEME;

// Make sure it's synchronize with scripts/workflow/data.ts
type Category =
	| "social-media"
	| "new-media"
	| "traditional-media"
